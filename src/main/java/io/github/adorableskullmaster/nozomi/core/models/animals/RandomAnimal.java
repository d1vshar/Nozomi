...
public class RandomAnimal {
  ...
  public String getCheweyCat() {
    try {
      String url = "https://api.chewey-bot.ga/cat?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
  ...
  public String getCheweyBirb() {
    try {
      String url = "https://api.chewey-bot.ga/birb?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweyRabbit() {
    try {
      String url = "https://api.chewey-bot.ga/rabbit?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweySnake() {
    try {
      String url = "https://api.chewey-bot.ga/snake?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweyOtter() {
    try {
      String url = "https://api.chewey-bot.ga/otter?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweyDog() {
    try {
      String url = "https://api.chewey-bot.ga/dog?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweyDuck() {
    try {
      String url = "https://api.chewey-bot.ga/duck?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
  ...
  public String getCheweyTurtle() {
    try {
      String url = "https://api.chewey-bot.ga/turtle?auth="+Bot.config.getCredentials().getCheweyKey();
      JSONObject result = new JSONObject(fetch(url));
      return result.getString("data");
    } catch (IOException e) {
      Bot.botExceptionHandler.captureException(e);
